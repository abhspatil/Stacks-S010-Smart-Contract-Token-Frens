...
(define-constant TOKEN_URI u"https://inscribe.ordbit.io/frens") ;; utf-8 string with token metadata host
(define-constant TOKEN_NAME ".Frens Token")
(define-constant TOKEN_SYMBOL "FRENS")
